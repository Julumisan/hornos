...
class HornoGUI:
    ...
    def __init_ui__(self):
        ...
        self.horno_control.root.configure(bg='lightgray')

        # Crea un marco para contener los widgets.
        self.horno_control.frame = tk.Frame(self.horno_control.root, bg='lightgray')
        ...
        self.horno_control.update_max_temp_button = tk.Button(max_temp_frame, text="Actualizar Máxima", command=self.update_max_temp, fg='blue', bg='white', font=("Arial", 12))
        ...
        self.horno_control.update_min_temp_button = tk.Button(min_temp_frame, text="Actualizar Mínima", command=self.update_min_temp, fg='blue', bg='white', font=("Arial", 12))
        ...
        self.horno_control.exitButton = tk.Button(self.horno_control.root, text="SALIR", command=self.horno_control.root.destroy, fg="white", bg="red", font=("Arial", 14))
        self.horno_control.exitButton.pack(side=tk.BOTTOM, pady=10)
    
        # Crea el botón de guardar los datos
        self.horno_control.save_button = tk.Button(self.horno_control.root, text="Guardar datos", command=self.exportar_datos_csv, fg='white', bg='green', font=("Arial", 14))
        self.horno_control.save_button.pack(side=tk.BOTTOM, pady=10)
    
        # Crea el botón de pausa
        self.horno_control.pause_button = tk.Button(self.horno_control.root, text="Pausar", command=self.horno_control.toggle_pause, fg='white', bg='blue', font=("Arial", 14))
    ...
    # Resto de métodos de la clase HornoGUI...
